1. В файле "/etc/hosts" добавить адреса локальных доменов.
	Например "127.0.0.1 test.loc"

2. В "./config/vhosts" добавить файлы доменов. 
	Например "test.loc.conf":

<VirtualHost *:80>
    ServerAdmin webmaster@localhost
    DocumentRoot /var/www/test.loc/public
    ServerName test.loc
	<Directory /var/www/test.loc/public>
		AllowOverride all
	</Directory>
</VirtualHost>
